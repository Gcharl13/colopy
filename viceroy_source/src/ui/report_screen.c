...
int report_open(int which)
{
    ...
    strcpy_near(titlebuf, (char near *)DG_PTR(KEY_REPORT)); /* @asm 0x03734B 0xD1D:0x7E4 */
...
void report_religious(int player)
{
    ...
    if (g_cheat_5383 & 0x20) {                    /* @asm 0x0379B9 TEST [0x5383],0x20 / JE */
        ...
        strcpy_near(buf, (char near *)DG_PTR(0x11A9)); /* @asm 0x0379D1 0xD1D:0xB48 (sprintf form) */
