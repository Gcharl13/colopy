 ...
 *
 * IDENTIFICATION NOTE (cite-or-left-unresolved honesty): none of these helpers has a
 ...
 * (callers are overlay-resident — body in thunk page); the body is fully byte-verified.
 *
 ...
 * first goes negative).  No load_image caller (overlay-resident — body in thunk page).
 *
 ...
 * Returns AX.
 *
 * No load_image caller (callers overlay-resident, e.g. Europe market screen — body in thunk page);
