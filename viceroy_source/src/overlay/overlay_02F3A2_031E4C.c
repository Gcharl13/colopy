...
void report_header_row(int draw_arg)
{
    ...
    strcat_far(NULL, NULL /* buf */);                               /* @asm 0x030F93 0x0D1D:0x117E */
    ...
    strcat_far(NULL, NULL /* buf */);                               /* @asm 0x03101B 0x0D1D:0x07A4 */
...
void report_table_16rows(int input_enabled)
{
    ...
    for (i = 0; i < 0x10; i++) {                         /* @asm 0x031253 16 rows */
        ...
        strcat_far(NULL, NULL /* buf */);                            /* @asm 0x031139 0x0D1D:0x7A4 */
...
void naval_list_panel(int input_enabled)
{
    ...
    strcat_far(NULL, NULL /* title */);                             /* @asm 0x0318F8 0x0D1D:0x117E */
...
int beveled_num_cell(int value, int x, int y, int mode)
{
    ...
    strcat_far(NULL, buf); /* second arg TODO */                                     /* @asm 0x031D51 0x0D1D:0x117E */
