...
| 2 | UNFORESTED | 8 | via `func_07637F(i)` (TBD-inner) | @asm 0x074A38 |
| 3 | FORESTED | 8 | REP MOVSW 8 words **0x2FF4→0x3074** (i*16) | @asm 0x074A7C |
| 4 | OTHER | 5 | via `func_07637F(i+0x18)` (TBD-inner) | @asm 0x074AA1 |
...
`TBD-inner` for func_0749E0. Everything else above is byte-verified.
