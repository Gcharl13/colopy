...
Externally-undefined symbols in `libviceroy_rules.a`: **2312**
...
| func_body | 184 | port the original `func_0XXXXX` body |
| named_gap | 746 | implement, or re-include excluded render/ audio/ source |
