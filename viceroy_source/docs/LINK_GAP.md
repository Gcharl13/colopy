...
Externally-undefined symbols in `libviceroy_rules.a`: **2190**
...
| func_body | 163 | port the original `func_0XXXXX` body |
| named_gap | 712 | implement, or re-include excluded render/ audio/ source |

Of 871 overlay thunks, **398** already have a resolved target name in `thunk_signatures.json` (ready to wire).
