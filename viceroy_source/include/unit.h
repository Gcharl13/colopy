...
struct UnitRecord {                /* base DGROUP:0x3144, stride 0x1C (28 bytes) */
    ...
    union {
        ...
        struct {
            ...
            uint8_t  field_at_14;     /* +0x14 alias for cargo_qty[4] */
            uint8_t  pad_15;          /* +0x15 alias for cargo_qty[5] */
        };
    };
    union {
        uint8_t  turn_counter;     /* +0x16 (0x315A)  inc to cap 8 then reset. @asm inc 0x2EFD6. */
        uint8_t  field_at_16;      /* +0x16 alias used by assignment/commodity code */
    };
