...
REPORTS = {
    ...
    "MAP": (None, ["--rendermap", FIXTURE, str(PAK), "{out}", "37", "23", "6",
            ...
            "Moves 6-vs-5 NARROWED 2026-09-03 (RULINGS 2026-09-03i2): NO "
            "site in the map-render range reads any move state (every "
            "read of the spent byte +0x3149 sits at or below 0x062F5C), "
            "so the DOS number is NOT a remaining budget -- the ports' "
            "decreasing 'Moves: n 1/3' has no byte support. The "
            "type-table block @0x069BD6..@0x069CEB ([0x5234]/3 = the "
            "movement column, loader @0x074F04) is the PEDIA stat block, "
            "not this line. The sidebar composer is still unlocated\n"
