...
REPORTS = {
    ...
    "COLONY": (("KEYS", "v", "Left", "Return"),
               ...
               "fix), and the area-view CROP aligns tile-for-tile; what "
               "remains in that panel (~3.6k px) is its WATER: the port "
               "draws the map renderer's coast halo and the seeded detail "
               "specks in the 5x5 downscale while the DOS area view shows "
               "neither -- the DOS area painter's tile source is OPEN. "
