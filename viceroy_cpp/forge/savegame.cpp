...
JsonValue dump_colony(const Colony& c) {
    ...
    o.obj["export_mask"]     = json_num(c.export_mask);
...
JsonValue dump_unit(const Unit& u) {
    ...
    o.obj["sail"]       = json_num(u.sail);
    o.obj["sail_dir"]   = json_num(u.sail_dir);
    o.obj["in_europe"]  = [&]{ JsonValue v; v.type = JsonValue::Bool; v.b = u.in_europe; return v; }();
...
Colony read_colony(const JsonValue& o) {
    ...
    c.export_mask      = (uint16_t)gi(o, "export_mask", 0);
...
Unit read_unit(const JsonValue& o) {
    ...
    u.sail       = gi(o, "sail", 0);
    u.sail_dir   = gi(o, "sail_dir", 0);
    u.in_europe  = gb(o, "in_europe", false);
