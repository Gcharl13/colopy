...
| Which options act | **PARTIAL** | **Combat Analysis** and, since 2026-09-02, **Tutorial Hints** (0x0080 — the byte gate of every @TUTORIALn lesson, RULINGS 2026-09-02d; on iff Discoverer at new game, @0x074348) change behaviour; the rest are stored and displayed truthfully but unconsumed (there is no piece-slide animation, no autosave, no water cycling in the port). |
