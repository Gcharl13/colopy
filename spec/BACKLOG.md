...
| 3 | Founding-Father acquisition | bell-cost curve **`func_03C282`**; selection `func_03BFD2`; effects `func_03BC42` | `systems/founding_fathers.md` | **RESOLVED 2026-06-19:** bell pool + cost curve **B**; era-band weighted selection **B**; **9 immediate-effect fathers byte-verified** (`func_03BC42` — Fugger/Coronado/La Salle/J.P.Jones/Pocahontas/Bolivar/Brewster/de Brebeuf/las Casas). Remaining: the 16 continuous-effect fathers (diffuse, applied at each system's site). |
