...
~~Score accumulator global **`DGROUP:0x372`** — zeroed at the top of `func_03A9C0` and written during scoring. **BYTE_VERIFIED** (`@0x3A9E5`/`@0x3A9EC`).~~ **Corrected 2026-09-02 (RULINGS 2026-09-02x):** `[0x372]` is the **palette-cycling enable**, saved @0x3A9E5, cleared @0x3A9EC and restored @0x3AD9F exactly as every full-screen PIK page does (`func_03BB4A` @0x3BB56/@0x3BC37, `func_03DA2A` @0x3DA5E/@0x3DE3A, `func_075352` @0x75368/@0x7558D); no score is ever written to it. The score lives in `func_03A9C0`'s locals (`[bp-2]` scaled, `[bp-0xC0]` panel).
...
- **Population gate, port note (2026-09-02):** the raw profession byte **0** (`@JOBEXPERT[0]`,
  ...
  port's `score_parts` had scored it +2 and now matches (RULINGS 2026-09-02x).
