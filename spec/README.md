...
| [`ui/advisor_reports.md`](ui/advisor_reports.md) | reports F2–F10 | **B** (real bodies `0x37958`…`0x39EE2`; F8 picker `0x23810`; F4/F8 separators = dark-red `0x77` rules to x=311/319; F10 font FONTTINY+FONTINTR) | non-Naval intra-row coords (deeper decompile) |
