...
| [`ui/popups.md`](ui/popups.md) | ~24 popups | **B** (framework: 10 live directives, channels = sprite-tint globals `[0x1F5C/5E/60]`, Lost-City map, raid=6, `@width`/`@x`/`@y`; FONTTINY latch) | body text color = glyph-engine mapping (A; no per-popup override) |
