...
**Total rendered: 738 sections across 11 files.**


### GAME.TXT — 499 `@`-section(s)
...
#### `@BEGINMENU`
*6 line(s) · directives: `width=160`, `y=91`, `smallfont=true`, `options=true`*
```text
...
#### `@GAMEOPTIONS`
*9 line(s) · directives: `width=190`, `checkbox=true`, `options=true`*
```text
Set Game Options
Show ~Indian Moves
Show ~Foreign Moves
...
#### `@COLONYOPTIONS`
*11 line(s) · directives: `width=220`, `checkbox=true`, `options=true`*
```text
...
#### `@SOUNDOPTIONS`
*4 line(s) · directives: `width=190`, `checkbox=true`, `options=true`*
```text
Set Sound Options
~Background Music
~Event Music
...
#### `@LEADERNAME`
*4 line(s) · directives: `width=300`, `options=true`*
```text
...
#### `@KINGRECRUIT`
*3 line(s) · directives: `width=190`, `smallfont=true`*
```text
...
#### `@CUSTOM`
*1 line(s) · directives: `width=190`, `checkbox=true`, `smallfont=true`*
```text
...
#### `@PICKMUSIC`
*16 line(s) · directives: `smallfont=true`, `width=220`*
```text
...
#### `@PICKINDEPENDENCE`
*6 line(s) · directives: `smallfont=true`, `width=220`*
```text
...
#### `@PICKMILITARY`
*5 line(s) · directives: `smallfont=true`, `width=220`*
```text
...
#### `@TUTORIAL16`
*8 line(s) · directives: `width=220`, `y=10`, `x=5`, `smallfont=true`*
```text
...
#### `@TUTORIAL17`
*11 line(s) · directives: `width=300`, `y=10`, `smallfont=true`*
```text
...
#### `@TUTORIAL18`
*7 line(s) · directives: `width=300`, `y=10`, `smallfont=true`*
```text
...
#### `@HELP1`
*15 line(s) · directives: `width=300`, `smallfont=true`*
```text
^^GENERAL INFORMATION
^
...
#### `@HELP2`
*20 line(s) · directives: `width=300`, `smallfont=true`*
```text
^^MOUSE COMMANDS
^
...
#### `@HELP3`
*15 line(s) · directives: `width=220`, `smallfont=true`*
```text
^^KEYBOARD COMMANDS
^
...
#### `@HELP4`
*16 line(s) · directives: `width=220`, `smallfont=true`*
```text
^^SPECIAL COMMANDS
^
...
#### `@OPTIONS`
*8 line(s) · directives: `width=220`, `checkbox=true`*
```text
