...
| map_file | start | end | x0 | y0 | x1 | y1 | x2 | y2 |
|---|---|---|---|---|---|---|---|---|
...
> byte anchor: loader @0x74EC3 maps cols -> runtime stat tables: attack->0x5236, combat/DEFENSE->0x5235 (LAND, accessor x8), guns->0x523B, ->0x523C (ship). [B, RULINGS wave-10]
