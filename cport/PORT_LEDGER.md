...
| `tileTerrain` | 356 | 1 |  | todo |
| `isWaterId` | 358 | 0 |  | todo |
| `tileWater` | 359 | 1 |  | todo |
| `tileHills` | 361 | 0 |  | todo |
| `tileMountains` | 362 | 2 |  | todo |
| `tileRiver` | 365 | 2 |  | todo |
...
| `setGoTo` | 2268 | 5 |  | todo |
| `advanceGoTo` | 2274 | 41 |  | todo |
| `terrainCol` | 2316 | 5 |  | todo |
| `improveWork` | 2322 | 0 |  | todo |
| `terrainMove` | 2323 | 0 |  | todo |
| `isHardy` | 2324 | 0 |  | todo |
| `canImprove` | 2325 | 1 |  | todo |
| `workThreshold` | 2327 | 6 |  | todo |
| `advanceImprovements` | 2334 | 61 |  | todo |
| `spendTools` | 2396 | 18 |  | todo |
| `tileYield` | 2415 | 26 |  | todo |
| `jobIndex` | 2442 | 27 |  | todo |
| `workplaceFor` | 2470 | 2 |  | todo |
| `jobForBuilding` | 2473 | 4 |  | todo |
| `chainCount` | 2478 | 8 |  | todo |
| `colonyUpkeep` | 2487 | 5 |  | todo |
| `totalUpkeep` | 2493 | 0 |  | todo |
| `payUpkeep` | 2494 | 13 |  | todo |
| `indoorRate` | 2508 | 7 |  | todo |
| `toryPenalty` | 2516 | 9 |  | todo |
| `isExpert` | 2526 | 8 |  | todo |
| `improvementBonus` | 2535 | 8 |  | todo |
| `fieldYield` | 2544 | 55 |  | todo |
| `FIELD_JOB_NAMES` | 2600 | 0 |  | todo |
| `bestFieldJob` | 2601 | 16 |  | todo |
| `indoorYield` | 2618 | 11 |  | todo |
| `colonyProduce` | 2630 | 72 |  | todo |
...
| `runSchool` | 2760 | 46 |  | todo |
| `updateSoL` | 2807 | 14 |  | todo |
| `warehouseLevel` | 2822 | 9 |  | todo |
| `autoExport` | 2832 | 72 |  | todo |
...
| `bandFor` | 4278 | 6 |  | todo |
| `rollImmigrant` | 4285 | 18 |  | todo |
| `seedMarket` | 4304 | 7 |  | todo |
| `askPrice` | 4312 | 0 |  | todo |
| `stepPrice` | 4313 | 20 |  | todo |
| `driftMarket` | 4334 | 8 |  | todo |
| `isBoycotted` | 4343 | 0 |  | todo |
| `sellGoods` | 4344 | 18 |  | todo |
| `buyGoods` | 4363 | 16 |  | todo |
...
| `colonyLevel` | 4998 | 5 |  | todo |
| `tensionBandIdx` | 5089 | 9 |  | todo |
| `adjustTension` | 5099 | 42 |  | todo |
...
| `conversionThreshold` | 5363 | 5 |  | todo |
| `attemptConversions` | 5369 | 21 |  | todo |
| `ageConverts` | 5391 | 26 |  | todo |
| `nativeDemands` | 5418 | 126 |  | todo |
| `clearObjection` | 5545 | 19 |  | todo |
| `roadObjection` | 5565 | 33 |  | todo |
| `surpriseRaidCheck` | 5599 | 6 |  | todo |
| `raidOutcome` | 5606 | 35 |  | todo |
| `raidTargetScore` | 5642 | 55 |  | todo |
| `nativeRaid` | 5698 | 122 |  | todo |
| `headingScore` | 5821 | 35 |  | todo |
| `nativeMoveAI` | 5857 | 55 |  | todo |
| `settlementCap` | 5913 | 3 |  | todo |
| `missionStrength` | 5917 | 7 |  | todo |
| `nativeTick` | 5925 | 21 |  | todo |
| `spawnBrave` | 5947 | 23 |  | todo |
...
| `defenceBonus` | 6791 | 13 |  | todo |
| `MISC` | 6805 | 0 |  | todo |
| `combatAnalysis` | 6806 | 77 |  | todo |
| `combatStrength` | 6884 | 6 |  | todo |
| `navalAttack` | 6891 | 38 |  | todo |
| `shoreBombardment` | 6930 | 27 |  | todo |
| `scoutColony` | 6958 | 32 |  | todo |
| `powerStrength` | 6991 | 2 |  | todo |
| `spanishSuccession` | 6994 | 38 |  | todo |
| `ownerAdjective` | 7033 | 2 |  | todo |
| `removeUnit` | 7036 | 16 |  | todo |
| `becomeType` | 7053 | 8 |  | todo |
| `applyDefeat` | 7062 | 118 |  | todo |
| `tryPromote` | 7181 | 33 |  | todo |
...
| `taxInterval` | 8602 | 11 |  | todo |
| `taxRaise` | 8614 | 8 |  | todo |
| `taxPretext` | 8623 | 18 |  | todo |
| `kingSalutation` | 8642 | 0 |  | todo |
| `kingTaxDemand` | 8643 | 31 |  | todo |
...
| `immigrationThreshold` | 10131 | 13 |  | todo |
| `crossesPerTurn` | 10145 | 3 |  | todo |
| `checkImmigration` | 10149 | 53 |  | todo |
| `SAV_PROFESSION` | 10203 | 1 |  | todo |
| `importSav` | 10205 | 287 |  | todo |
...
| `endTurn` | 10724 | 98 |  | todo |
| `moveCost` | 10823 | 5 |  | todo |
| `step` | 10829 | 32 |  | todo |
