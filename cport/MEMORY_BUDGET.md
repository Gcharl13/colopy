...
| microSD | `COLOPY.PAK` (3,392,356 B with the Part E screens, 2026-09-02; 3,149,165 B before), `COLAUDIO.PAK` when present, `.SAV` files + their `.CPX` sidecars — the only writable store |
